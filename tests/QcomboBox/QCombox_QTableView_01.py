...
class TableModel(QtCore.QAbstractTableModel):
    """
    A simple 5x4 table data_structures to demonstrate the delegates
    """
...
class ComboDelegate(QItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        # self.combo.setGeometry(rectangle.adjusted(15, 15, -15, -15))
...
if __name__=="__main__":
    ...
    class Widget(PyQt5.QtWidgets.QWidget):
        """
        A simple test widget to contain and own the data_structures and table.
        """

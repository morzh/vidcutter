...
if sys.platform.startswith("linux") and ci_build_and_not_headless:
...
videos_folder = '/media/anton/1e894684-3165-4ae7-9ef9-92b66b4e94ca/home/anton/work/fitMate/datasets/hand_markup'
videos_list_path = '/home/anton/Downloads/Telegram Desktop'
videos_list_path_timestamps = '/home/anton/work/fitMate/datasets/squats_2022/new_pickle/'

image_size = 128
data_input_filename = '23.11.24.pickle'
data_output_filename = '23.11.24__.pickle'

app = QApplication(sys.argv)

with open(os.path.join(videos_folder, data_input_filename), 'rb') as f:
...
for video in videoList:
    ...
    clip = VideoFileClip(os.path.join(videos_folder, video.filename))
    video_item_._fps = clip.fps
    ...
    for clip in video.clips:
        ...
        for timestamp in clip.clip_timestamps:
            video_item_clip_.clip_timestamps.append(timestamp)
...
with open(os.path.join(videos_folder, data_output_filename), 'wb') as f:
